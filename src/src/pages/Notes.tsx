...
export function Notes({ reports, semesters, initialQuery = '', targetEvaluationId, onTargetHandled, scopeLabel, studentName, formation, demo = false, changeStates, onSeen, onSeenMany, debugMode = false, onDebugState, sharingEnabled }: NotesProps) {
...
type GroupedProps = Pick<NotesProps, 'studentName' | 'formation' | 'changeStates' | 'onSeen' | 'onDebugState'> & { evaluations: NoteRow[]; demo: boolean; debugMode: boolean; sharingEnabled: boolean };

function Grouped({ evaluations, studentName, formation, demo, sharingEnabled, changeStates, onSeen, debugMode, onDebugState }: GroupedProps) {
